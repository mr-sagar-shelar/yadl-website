...
export const borderStyle = atomWithStorage("box-border-size", {
    key: "border-solid",
    label: "SOLID"
});
export const borderRadius = atomWithStorage("box-border-size", {
    key: "rounded-none",
    label: "NONE"
});
export const opacity = atomWithStorage("box-border-size", {
    key: "opacity-100",
    label: "100"
});
